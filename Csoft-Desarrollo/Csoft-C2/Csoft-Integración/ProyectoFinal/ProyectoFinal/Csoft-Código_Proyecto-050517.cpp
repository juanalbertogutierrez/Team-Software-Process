...
/*Componente: Proyecto                                 */
/*Fecha:05/05/17                                           */
/*Descripción:Programa Principal de Control Escolar.           */
/*Versión: 0.1                                             */
/*=========================================================*/
...
#include <cstdlib>
#include "sqlite3.h"
#include "Csoft-Código_Altas-080517.h"
#include "Csoft-Código_Bajas-100517.h"
#include "Csoft-Código_Cambios-090517.h"
...
int main()
{
    ...
    menu_principal();
    sqlite3_close(db);                                                                          /*Menú Principal*/
    return 0;
}
